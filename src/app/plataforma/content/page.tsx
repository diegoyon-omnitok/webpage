          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:items-stretch">
            ...
            <div className="relative flex items-end justify-center lg:justify-end w-full min-w-0 pl-0 lg:pl-2 self-end">
              <Image
                ...
                alt="Omnitok Content — contenido enriquecido para PDPs en retailers y marketplaces"
                title="Omnitok Content — plataforma de contenido enriquecido para ecommerce"
                width={1600}
                height={1000}
