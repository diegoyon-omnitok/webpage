...
const stats = [
  {
    value: "+1M",
    label: "PUBLICAÇÕES AUDITADAS\nDIARIAMENTE",
  },
  {
    value: "+1.000",
    label: "SITES ANALISADOS\nDIARIAMENTE",
  },
  {
    value: "99,5%",
    label: "PRECISÃO\nDE DADOS",
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-14">
          <h2 className="text-3xl lg:text-5xl font-bold uppercase text-white tracking-[0.06em]">
            Nossa tecnologia em números
          </h2>
          <p className="mt-5 text-sm leading-relaxed max-w-3xl mx-auto text-white/80 lg:text-base">
            Dados operacionais reais da plataforma Omnitok DSA, atualizados com base na operação diária com marcas no Brasil e na América Latina.
          </p>
        </div>
