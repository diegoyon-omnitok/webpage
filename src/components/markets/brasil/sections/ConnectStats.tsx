...
const stats = [
  { value: 70, suffix: "%", label: "Redução no time to market" },
  { value: 68, suffix: "%", label: "Menos erros em páginas de produto" },
  { value: 80, suffix: "%", label: "Menos retrabalho operacional" },
];
    ...
    <section ref={ref} className="relative min-h-0 lg:min-h-[100dvh] flex flex-col justify-center py-16 lg:py-24 overflow-hidden box-border w-full gradient-hero">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-14">
          <h2 className="text-3xl lg:text-4xl font-bold text-white tracking-tight">Omnitok PIM em números</h2>
          <p className="mt-4 text-base max-w-xl mx-auto" style={{ color: "rgba(255,255,255,0.6)" }}>Com base em dados de operação com marcas que gerenciam catálogos em múltiplos varejistas.</p>
        </div>
