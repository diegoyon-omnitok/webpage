...
const topSkus = [
  ...
  { sku: "SKU-1035", name: "Fritadeira Air Fryer 6L", retailer: "Retail 2", views: 9650 },
  { sku: "SKU-1042", name: "Geladeira Frost Free 340L", retailer: "Retail 1", views: 8320 },
  { sku: "SKU-1058", name: "Máquina de Lavar 12kg", retailer: "Retail 3", views: 7100 },
...
const retailerBreakdown = [
  ...
  { name: "Outros", skus: 42, views: 10100, pct: 8 },
];
    ...
    <div className="rounded-xl overflow-hidden border border-gray-200 bg-white text-[11px] leading-tight" style={{ fontSize: "11px" }}>
      <div className="px-3 py-2.5 flex items-center justify-between" style={{ background: headerBg }}>
        <div>
          ...
          <p className="text-[9px] text-white/40">416 SKUs com conteúdo ativo · Últimos 30 dias</p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-px bg-gray-100">
        {[
          { label: "Visitas totais", value: "126.8K", color: "#4D4A9D" },
          { label: "SKUs ativos", value: "416", color: "#FF177B" },
          { label: "Varejistas com conteúdo", value: "12", color: "#22c55e" },
        ].map((kpi) => (
      ...
      <div className="px-3 pt-2.5 pb-1">
        <p className="text-[9px] font-bold text-gray-500 uppercase tracking-wider mb-1.5">SKUs mais visitados</p>
      </div>
      <table className="w-full">
        <thead>
          <tr className="bg-gray-50">
            {["SKU", "Produto", "Varejista", "Visitas"].map((h) => (
      ...
      <div className="px-3 pt-3 pb-1 border-t border-gray-100">
        <p className="text-[9px] font-bold text-gray-500 uppercase tracking-wider mb-1.5">Visitas por varejista</p>
      </div>
      <table className="w-full">
        <thead>
          <tr className="bg-gray-50">
            {["Varejista", "SKUs ativos", "Visitas", "% do total", ""].map((h) => (
              <th key={h} className="px-2 py-1.5 text-left font-bold text-gray-500 uppercase tracking-wider" style={{ borderBottom: cellBorder, fontSize: "8px" }}>{h}</th>
            ))}
          </tr>
        </thead>
