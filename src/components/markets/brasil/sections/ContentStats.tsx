...
const stats = [
  { value: 150, suffix: "+", label: "Varejistas com conteúdo ativo" },
  { value: 30, suffix: "%", label: "Mais tempo na PDP" },
  { value: 35, suffix: "%", label: "Aumento de conversão" },
];
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-14">
          <h2 className="text-3xl lg:text-4xl font-bold text-white tracking-tight">Omnitok Content em números</h2>
          <p className="mt-4 text-base max-w-xl mx-auto" style={{ color: "rgba(255,255,255,0.6)" }}>Com base em dados de implementações ativas com marcas no Brasil e na América Latina.</p>
        </div>
