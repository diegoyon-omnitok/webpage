...
const problems = [
  {
    icon: FileX,
    number: "01",
    title: "PDPs que não convertem",
    desc: "Páginas de produto incompletas, sem conteúdo enriquecido nem argumentos de compra claros. Cada visita sem conversão é uma venda perdida.",
  },
  {
    icon: RefreshCcw,
    number: "02",
    title: "Informações inconsistentes entre canais",
    desc: "O mesmo produto aparece diferente em cada varejista. Preços, descrições e imagens que não coincidem prejudicam a percepção da marca.",
  },
  {
    icon: EyeOff,
    number: "03",
    title: "Sem visibilidade da execução digital",
    desc: "Você não sabe como seus produtos aparecem em cada canal, o que está falhando nem onde está perdendo para a concorrência.",
  },
  {
    icon: Clock,
    number: "04",
    title: "Operação manual que não escala",
    desc: "Planilhas, e-mails e processos manuais para atualizar catálogos em dezenas de varejistas. Cada mudança leva dias em vez de minutos.",
  },
  {
    icon: BarChart2,
    number: "05",
    title: "Dados dispersos, decisões lentas",
    desc: "Informações de preço, estoque e conteúdo espalhadas em várias fontes. Sem uma visão consolidada, as oportunidades se perdem.",
  },
  {
    icon: AlertTriangle,
    number: "06",
    title: "Produtos invisíveis para o consumidor",
    desc: "Conteúdo não otimizado para os algoritmos de cada varejista faz seus produtos perderem posicionamento e visibilidade frente aos concorrentes.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="max-w-2xl mx-auto text-center mb-14">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-accent/10 border border-accent/20 mb-5">
            ...
            <span className="text-xs font-semibold text-accent">O desafio das marcas hoje</span>
          </div>

          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight">
            Sua marca está nos varejistas.
          </h2>

          <p className="mt-5 text-lg text-gray-500 leading-relaxed max-w-xl mx-auto">
            Mas como ela aparece? Vender por meio de varejistas e marketplaces é só o primeiro passo.
            O verdadeiro desafio é controlar como sua marca é executada em cada canal digital.
          </p>
        </div>
        ...
        <div className="mt-14 text-center">
          ...
          >
            ...
            <p className="text-sm font-semibold text-primary">
              A Omnitok resolve esses problemas com uma plataforma modular
            </p>
