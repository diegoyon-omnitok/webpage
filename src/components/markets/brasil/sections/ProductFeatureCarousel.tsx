...
/**
 * Mesmo bloco que “Por que escolher o Omnitok Content?”: cards com faixa superior,
 * zigue-zague texto/visual e ícone + etiqueta 01 — …
 */
    ...
    <section className="py-12 lg:py-20 bg-gray-50 box-border w-full">
      <div className="max-w-6xl mx-auto px-6 lg:px-8 w-full">
        ...
        <div className="flex flex-col items-center gap-4 mt-12 pt-10 border-t border-gray-200">
          <p className="text-xs font-bold uppercase tracking-widest text-accent">Você se identifica com isso?</p>
          <Link
          ...
          >
            Agende uma conversa <ArrowRight size={17} />
          </Link>
        </div>
      </div>
    </section>
