...
import { blogPostsPtBrCards } from "@/lib/blog";
import { canonicalRoutes } from "@/lib/markets";

export default function ResourcesHub() {
  const latestPosts = blogPostsPtBrCards.slice(0, 4);
  const resources = [
    ...
    })),
    {
      ...
      icon: FlaskConical,
      title: "Omnitok LABS",
      desc: "Diagnóstico gratuito: Share of Search, análise de PDP e faixas de preço com insights gerados por IA.",
      href: "https://lab.omnitok.com/",
      cta: "Ir para o Omnitok LABS",
      coverImage: labsCover.src,
      coverImageAlt: "Omnitok LABS com painel de métricas e análise de execução digital",
      external: true,
    },
  ] as const;
