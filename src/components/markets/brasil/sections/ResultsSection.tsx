...
const stats = [
  { value: 50, suffix: "+", label: "Marcas confiam na Omnitok" },
  { value: 150, suffix: "+", label: "Varejistas conectados" },
  { value: 1, suffix: "M+", label: "Publicações auditadas por dia" },
  { value: 99, suffix: "%", label: "Precisão dos dados" },
];
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <p className="mt-4 text-base text-white/60 max-w-xl mx-auto">
            Marcas líderes em tecnologia, eletro, beleza e bens de consumo confiam na Omnitok para melhorar sua execução digital em varejistas e marketplaces.
          </p>
        </div>
