...
const pins: MapPin[] = [
  ...
  { name: "Colômbia", leftPct: 26.5, topPct: 51.0, size: 2 },
  { name: "Peru", leftPct: 25.0, topPct: 59.8, size: 2 },
  { name: "México", leftPct: 16.6, topPct: 42.0, size: 3 },
  { name: "Equador", leftPct: 24.6, topPct: 56.2, size: 1 },
  { name: "América Central", leftPct: 22.7, topPct: 47.2, size: 2 },
...
export default function SobreNosMap() {
  return (
    <section className="py-16 bg-white">
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <h2 className="text-2xl lg:text-3xl font-bold text-gray-900">Estamos onde estão os seus varejistas</h2>
          <p className="mt-3 text-gray-500 max-w-xl mx-auto">
            Operamos na maior parte da América Latina, com presença também na Europa e nos Estados Unidos.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
          ...
          <div className="relative overflow-hidden rounded-xl bg-white ring-1 ring-gray-200/60 shadow-inner">
            <div className="relative select-none leading-none">
              ...
              <img
                ...
                alt="Mapa de presença da Omnitok na América Latina — varejistas e marketplaces integrados"
                title="A Omnitok opera em mais de 10 países da América Latina"
                width={950}
                height={620}
        ...
        <p className="mt-8 text-center text-sm text-gray-500 max-w-md mx-auto">
          As marcações indicam presença ou operação na região. Tamanho ilustrativo.
        </p>
      </div>
    </section>
  );
