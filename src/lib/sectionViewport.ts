 ...
 */
export const sectionViewport = "min-h-0 lg:min-h-[100dvh] flex flex-col justify-center box-border w-full";
...
export const sectionViewportStart = "min-h-0 lg:min-h-[100dvh] flex flex-col justify-start box-border w-full";
